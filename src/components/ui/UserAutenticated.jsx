  ...
  return (
    <div>
      ...
      >
        ...
        <img className='rounded-full' src={user.avatar ? `https://res.cloudinary.com/caraje/image/upload/v1679717935/${user.avatar}` : '/imgs/no-avatar.webp'} alt='Imagen de avatar de Caraje' width={40} height={40} />
      </button>
      {
